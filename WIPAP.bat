...
call :ResetALL
call :testip
if NOT exist ".\!_ipver!result.txt" (echo.[[94mINFO[30m]-FULLSTEP-!_ipver! [91mÃ»ÓĞ¿ÉÓÃ½á¹û, ÖØ¸´ÔËĞĞ[30m... & goto :fullstep)
call :ifinstallwarp
call :ifzerotrust
...
call :ResetALL
call :testip
if NOT exist ".\!_ipver!result.txt" (echo.[[94mINFO[30m]-Get!_ipver!IP [91mÃ»ÓĞ¿ÉÓÃ½á¹û, ÖØ¸´ÔËĞĞ[30m... & goto :get10ip)
:if10ip
set "_line=0"
...
if !_line! LSS 10 (
	echo.[[94mINFO[30m]-Get!_ipver!IP [91mĞ¡ÓÚ10¸ö½á¹û, ÖØ¸´ÔËĞĞ[30m...
	goto :get10ip
) else (
	md "#Result" >nul 2>nul
...
if !_winver! LSS 10.0 (call :ErrorWarn "ÄãµÄWindowsÏµÍ³°æ±¾µÍÓÚWin10-Éı¼¶Windows°æ±¾" & exit)
goto :eof

:ifzerotrust
warp-cli settings list | findstr /R "^(user set)[ ]*Organization:.*$" && call :ErrorWarn "ÄãÕıÔÚÊ¹ÓÃZero Trust-ÍË³öZero Trust" & exit
pause